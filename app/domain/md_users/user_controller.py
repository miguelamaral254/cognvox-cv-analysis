...
def update_user_status_endpoint(
    ...
    if current_user.role != 'admin':
        ...
        raise HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail="Apenas administradores podem alterar o status.")
...
def update_user_role_endpoint(
    ...
    return user_service.update_user_role(user_id, role_data.role, atualizado_por=current_user.id) 
